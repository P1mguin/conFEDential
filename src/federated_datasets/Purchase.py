...
class Purchase(Dataset):
	...
	def load_data(
		...
		cache_file = f".cache/preprocessed/purchase/{seed}{alpha}{percent_non_iid}{client_count}{batch_size}/{function_hash}"
		...
		purchase = np.load(".cache/purchase/purchase100.npz")
